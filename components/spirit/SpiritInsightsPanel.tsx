...
import type { SpiritInsight } from '@/lib/types'
import { cn } from '@/lib/utils'

const priorityConfig = {
  high: { icon: AlertTriangle, color: 'text-rose-400', border: 'border-rose-500/20', bg: 'bg-rose-500/6' },
  medium: { icon: TrendingUp, color: 'text-violet-400', border: 'border-violet-500/20', bg: 'bg-violet-500/6' },
  low: { icon: Info, color: 'text-slate-400', border: 'border-white/8', bg: 'bg-white/3' },
}
...
export function SpiritInsightsPanel({ insights }: Props) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-display text-sm font-bold text-white">Spirit Insights</h3>
