...
import { Brain, AlertTriangle, Lightbulb, TrendingUp, Info } from 'lucide-react'
import type { BodyInsight } from '@/lib/types'
...
export function BodyInsightsPanel({ insights }: Props) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-display text-sm font-bold text-white">Body Insights</h3>
